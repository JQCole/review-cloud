...
Welcome to ``review-cloud`` contributor's guide.
...
If you experience bugs or general issues with ``review-cloud``, please have a look
...
You can help improve ``review-cloud`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``review-cloud`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``review-cloud``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n review-cloud python=3 six virtualenv pytest pytest-cov
    conda activate review-cloud
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/review-cloud.git
    cd review-cloud
...
#. Install |pre-commit|_::
   ...
   ``review-cloud`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/review-cloud
.. _issue tracker: https://github.com/<USERNAME>/review-cloud/issues
.. <-- end -->
